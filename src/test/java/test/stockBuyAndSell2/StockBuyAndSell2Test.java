...
public class StockBuyAndSell2Test {
	...
	@Test
	void stockBuyAndSell2_whenArrayGiven_thenReturnsProfit()
	{
		assertEquals(4, StockBuyAndSell2.maxProfit(new int[] {1, 5, 4, 2, 1}));
	}
	
	@Test
	void stockBuyAndSell2_whenGivenArrayNoProfit_thenReturnsZero()
	{
		assertEquals(0, StockBuyAndSell2.maxProfit(new int[] {6, 5, 4, 2, 1}));
	}
	
	@Test
	void stockBuyAndSell2_whenGivenArrayIsSame_thenReturnsZero()
	{
